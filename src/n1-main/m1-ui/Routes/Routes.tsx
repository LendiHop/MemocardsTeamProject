...
import {EnterNewPasswordContainer} from "../../../n2-features/f1-auth/a4-enterPassword/EnterNewPasswordContainer";
...
import {LinkOnEmail} from "../../../n2-features/f1-auth/a3-passwordRecovery/LinkOnEmail";
...
export const Routes = () => {
    ...
    return (
        <Switch>
            ...
            <Route path="/set-new-password" render={() => <EnterNewPasswordContainer/>}/>
            <Route path={"/404"} render={() => <Error404/>}/>
            <Route path={"/go-to-email"} render={() => <LinkOnEmail/>}/>
